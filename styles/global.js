  ...
  <Global
    styles={css`
      ...
      *:after {
      ...
      :root {
        --font-family-body: 'Proxima Nova', 'Helvetica Neue', sans-serif;
        --font-family-heading: 'Proxima Nova', 'Helvetica Neue', sans-serif;
        ...
        --project-description: var(--size-5);
        @media (min-width: 700px) {
          --project-description: var(--size-5);
        }
      }
